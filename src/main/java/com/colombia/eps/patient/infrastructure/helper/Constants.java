...
public final class Constants {
    ...
    public static final String ERROR_UPDATING_PATIENT = "Error al actualizar el %s";
    ...
    public static final String PATIENT_CREATED_SUCCESSFULLY = "Paciente %s %s creado satisfactoriamente";
