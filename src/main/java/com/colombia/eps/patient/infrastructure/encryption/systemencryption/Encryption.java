package com.colombia.eps.patient.infrastructure.encryption.systemencryption;
...
public class Encryption {
    ...
    protected PublicKey getPublicKey() {
       try (FileInputStream fis = new FileInputStream(Objects.requireNonNull(getClass().getClassLoader().getResource(certificateName)).getPath())){
